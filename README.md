...
| METRICS_PORT | false | 8000 | Set Metrics port, require METRICS_ENABLE to be enabled |
...
| CA_CRT | false | - | path to Dex GRPC client certificate authority |
| DEX_MAX_RETRIES | false | 20 | How many retries need to wait for Dex to be reachable |
...
| variable | required  | default | description |
|:---------:|:---------:|:-------:|:------------:|
| VAULT_ADDR | false | http://127.0.0.1:8200 | vault address |
...
| VAULT_CERT_CA | false | - | Vault certificate authority path or bool, `false` - do not validate, `true` - validate with internal truststore |
...
| VAULT_MAX_RETRIES | false | 20 | How many retries need to mark Vault unreachable |
